...
//  $email_to = "callum@sakurabrae.co.uk";
  $email_subject = "The following enquiry was made through the Personal Injury Calculator at Watermans.ws";
...
// create email headers
    ...
    echo('<script type="text/javascript">top.window.location="/personal-injury-compensation-calculator/thank-you";</script>');
  }
}
?>
